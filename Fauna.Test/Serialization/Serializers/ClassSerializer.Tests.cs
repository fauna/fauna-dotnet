...
public class ClassSerializerTests
{
    ...
    {
        var serializer = SerializerProvider.Generate<Person>(_ctx);
    ...
    {
        var serializer = SerializerProvider.Generate<PersonWithAttributes>(_ctx);
    ...
    {
        {
            ...
            {
                var serializer = (ISerializer<IOnlyField>)SerializerProvider.Generate(_ctx, obj.GetType());
    ...
    {
        var serializer = SerializerProvider.Generate<ClassForDocument>(_ctx);
    ...
    {
        var serializer = SerializerProvider.Generate<ClassWithShort>(_ctx);
