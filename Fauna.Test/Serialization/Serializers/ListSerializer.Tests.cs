...
public class ListSerializerTests
{
    ...
    {
        var serializer = Serializer.Generate<List<int>>(s_ctx);
    ...
    {
        var serializer = Serializer.Generate<List<PersonWithAttributes>>(s_ctx);
    ...
    {
        var serializer = Serializer.Generate<IEnumerable<int>>(s_ctx);
    ...
    {
        var serializer = Serializer.Generate<List<string>>(s_ctx);
