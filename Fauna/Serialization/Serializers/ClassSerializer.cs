...
internal class ClassSerializer<T> : BaseSerializer<T>, IClassDocumentSerializer
{
    ...
    private readonly IReadOnlySet<string> _skipNoFields = new HashSet<string>();
    private readonly IReadOnlySet<string> _skipColAndTs = new HashSet<string> { "coll", "ts" };
    private readonly IReadOnlySet<string> _skipIdAndColAndTs = new HashSet<string> { "id", "coll", "ts" };
