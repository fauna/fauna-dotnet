...
internal class DocumentSerializer<T> : BaseSerializer<T> where T : class
{
        ...
        while (reader.Read() && reader.CurrentTokenType != TokenType.EndDocument)
        {
            ...
            switch (fieldName)
            {
                case "id":
                    ...
                    break;
                case "name":
                    name = DynamicSerializer.Singleton.Deserialize(context, ref reader);
                    break;
                case "coll":
                ...
                case "ts":
                    ...
                    break;
                default:
                    data[fieldName] = DynamicSerializer.Singleton.Deserialize(context, ref reader);
                    break;
            }
        }
